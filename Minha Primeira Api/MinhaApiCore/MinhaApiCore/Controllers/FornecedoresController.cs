...
namespace MinhaApiCore.Controllers
{
    ...
    public class FornecedoresController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Fornecedor>>> GetGetFornecedores()
        {
            return await _context.GetFornecedores.ToListAsync();
        }
        ...
        {
            var fornecedor = await _context.GetFornecedores.FindAsync(id);
        ...
        {
            _context.GetFornecedores.Add(fornecedor);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Fornecedor>> DeleteFornecedor(Guid id)
        {
            ...
            _context.GetFornecedores.Remove(fornecedor);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.GetFornecedores.Any(e => e.Id == id);
        }
    }
}
